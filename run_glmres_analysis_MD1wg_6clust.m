indir = [pwd '/output/roi_summaries_MD1wg_6clust'];
infix = 'MD1wg_sm_clusters6';
indir_demog = '/space/md12/8/data/MMILDB/HAG_PING/analysis/PING/data';
instem_demog = 'PING_demog_150424';
results_outdir = [pwd '/output/output_glmres_MD1wg_6clust'];
data_outdir = [pwd '/output/roi_summaries_MD1wg_6clust_resid'];
merge_field = 'VisitID';
